...
CREATE TABLE doctor (
        ...
        degree_year INTEGER NOT NULL CHECK (degree_year >= 1900 AND degree_year <= extract(year from current_date)),
...
CREATE TABLE doctor_phone (
        ...
        phone_num VARCHAR(10), --they may not have a phone, or phone number is wrong and need to be reviewed
...
CREATE TABLE outpatient (
        ...
        dob DATE,
        address VARCHAR,
        phone VARCHAR(10), -- some one may have no phone
        gender SEX NOT NULL,
        PRIMARY KEY (pid)
);
